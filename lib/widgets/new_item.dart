...
class _NewItemState extends State<NewItem> {
  ...
  //_formKey.currentState!.validate() executes the validator functions within the form{
  void _saveItem() async {
    if (_formKey.currentState!.validate()) {
      _formKey.currentState!
          .save(); // only after checking if there are valid inputs
      setState(() {
        _isSending = true;
      });
      ...
      final response = await http.post(
        ...
        body: json.encode({
          ...
          "category": _selecetedCategory.title,
        }),
      );
          ...
          child: Column(
            children: [
              TextFormField(
                ...
                //below thing runs when _formKey.currentState.save() gets executed
                onSaved: (value) {
                  _enteredName = value!;
                },
              ),
